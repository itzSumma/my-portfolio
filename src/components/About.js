...
import { Code2, Server, Database, MapPin, Briefcase, FolderGit2, Laptop, BadgeCheck, ArrowRight } from "lucide-react";
...
export default function About() {
  ...
  const features = [
    {
      ...
      description: "Building pixel-perfect, responsive, and highly interactive user interfaces using React, Next.js, and Tailwind CSS."
    },
    {
      icon: <Server className="w-6 h-6 text-primary" />,
      title: "Backend Development",
      description: "Architecting secure, scalable server-side logic and RESTful APIs using Node.js and Express."
    },
    {
      icon: <Database className="w-6 h-6 text-primary" />,
      title: "Database Management",
      description: "Designing efficient schemas and handling data persistence with MongoDB and Mongoose for optimal performance."
    }
  ];
  ...
  return (
    <section id="about" className="relative min-h-screen flex flex-col justify-center px-6 md:px-24 py-32 overflow-hidden bg-background">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
          ...
          >
            ...
            <p className="text-white/70 font-body leading-relaxed text-base">
              I believe great software is more than just writing code. My goal is to
              build applications that are intuitive, reliable, and easy to maintain,
              with a strong focus on performance and user experience.
            </p>

            <p className="text-white/60 font-body leading-relaxed text-sm">
              Every project is an opportunity to learn, improve, and solve meaningful
              problems. I value clean architecture, attention to detail, and writing
              code that remains scalable and maintainable over time.
            </p>
          </motion.div>
          ...
          >
            ...
            <p className="text-white/70 font-body leading-relaxed text-base">
              My journey into web development began with curiosity and has grown into a
              passion for building complete web applications. Through consistent
              learning and hands-on projects, I've developed both my technical skills
              and problem-solving mindset.
            </p>

            <p className="text-white/60 font-body leading-relaxed text-sm">
              I believe continuous learning is the key to growth. Every challenge,
              project, and new technology helps me become a more capable developer and
              prepares me to build better software.
            </p>
          </motion.div>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-6 w-full lg:w-auto flex-grow">
            {quickFacts.map((fact, index) => (
              <div key={index} className="space-y-1">
                ...
                <p className="text-sm font-semibold text-white/90">{fact.value}</p>
              </div>
            ))}
          </div>
